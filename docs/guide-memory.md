...
Persistent storage using PostgreSQL with vector search support (pgvector).
...
Supports semantic search via pgvector embeddings. The `asyncpg` dependency is bundled with sr2-pro.
