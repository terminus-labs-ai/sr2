    ...
    return [
        EvalCase(
            ...
            conversation_turns=[
                ...
                ("Should we use Stripe or custom?", "Stripe is recommended for faster time-to-market."),
                ("Let's go with Stripe", "Great choice. Stripe is reliable and well-documented."),
                ("What about PCI compliance?", "Stripe handles PCI compliance, you don't need to worry."),
                ("Can you remind me what we chose for payments?", "We decided to use Stripe for PCI compliance handling."),
            ],
            expected_key_facts=[
                "Stripe",
                "payment system",
        ...
        EvalCase(
            ...
            conversation_turns=[
                ...
                ("Never mind, back to database", "No problem, let's return to the database schema."),
    ...
    return [
        EvalCase(
            ...
            conversation_turns=[
                ...
                ("What was our decision?", "You chose monolith initially, migrating to microservices when you scale."),
            ],
            expected_key_facts=[
                "monolith",
                "microservices",
