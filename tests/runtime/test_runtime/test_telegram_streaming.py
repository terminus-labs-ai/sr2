...
from sr2_runtime.llm.streaming import StreamEndEvent, TextDeltaEvent, ToolResultEvent, ToolStartEvent
...
class TestMdToTelegramHtml:
    ...
    def _convert(self, text: str) -> str:
        from sr2_runtime.plugins.telegram import _md_to_telegram_html
...
class TestStripMarkdown:
    ...
    def _strip(self, text: str) -> str:
        from sr2_runtime.plugins.telegram import _strip_markdown
...
class TestTelegramStreamState:
    def _make_state(self):
        from sr2_runtime.plugins.telegram import _TelegramStreamState
    ...
    async def test_overflow_starts_new_message(self):
        from sr2_runtime.plugins.telegram import _MSG_LIMIT
    ...
    async def test_first_send_too_long_splits(self):
        ...
        from sr2_runtime.plugins.telegram import _TelegramStreamState, _MSG_LIMIT
